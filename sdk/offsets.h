...
{
public:
	static constexpr std::uintptr_t GWORLD = 0x1A6536B0;
	static constexpr std::uintptr_t GAME_INSTANCE = 0x240;
	...
	static constexpr std::uintptr_t GAME_STATE = 0x1C8;
	...
	static constexpr std::uintptr_t BONE_ARRAY_INDEX = 0x6B0;
};
